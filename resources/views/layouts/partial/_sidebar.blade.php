    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="kategori">
          ...
          <li class="nav-item"> <a class="nav-link" href="{{ route('category') }}"> Kategori</a></li>
          <li class="nav-item"> <a class="nav-link" href="{{ route('sub_category') }}"> Sub Kategori</a></li>
          </ul>
          </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="produk">
            <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{ route('add_product') }}">Tambah Produk</a></li>
            <li class="nav-item"> <a class="nav-link" href="{{ route('product') }}">Data Produk</a></li>
            </ul>
        </div>
       </li>
